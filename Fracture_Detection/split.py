...
if __name__ == "__main__":
    ...
    img_dir = "/root/autodl-tmp/GRAZPEDWRI-DX_dataset/data/images"
    ann_dir = "/root/autodl-tmp/GRAZPEDWRI-DX_dataset/data/labels"
    df = pd.read_csv("/root/autodl-tmp/dataset.csv")
    ...
    train_df.to_csv("/root/autodl-tmp/GRAZPEDWRI-DX_dataset/train_data.csv", index=False)
    valid_df.to_csv("/root/autodl-tmp/GRAZPEDWRI-DX_dataset/valid_data.csv", index=False)
    test_df.to_csv("/root/autodl-tmp/GRAZPEDWRI-DX_dataset/test_data.csv", index=False)

    img_train_dir = "/root/autodl-tmp/GRAZPEDWRI-DX_dataset/data/images/train"
    img_valid_dir = "/root/autodl-tmp/GRAZPEDWRI-DX_dataset/data/images/valid"
    img_test_dir = "/root/autodl-tmp/GRAZPEDWRI-DX_dataset/data/images/test"
    ann_train_dir = "/root/autodl-tmp/GRAZPEDWRI-DX_dataset/data/labels/train"
    ann_valid_dir = "/root/autodl-tmp/GRAZPEDWRI-DX_dataset/data/labels/valid"
    ann_test_dir = "/root/autodl-tmp/GRAZPEDWRI-DX_dataset/data/labels/test"
    ...
    print(f"  - {len(train_df)} ({100 * len(train_df) / N:.3f}%) image    s in the training set.")
